...
extension RecentQueryFilter on QueryBuilder<Recent, Recent, QFilterCondition> {
  QueryBuilder<Recent, Recent, QAfterFilterCondition> createdAtIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Recent, Recent, QAfterFilterCondition> createdAtIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Recent, Recent, QAfterFilterCondition> createdAtEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Recent, Recent, QAfterFilterCondition> createdAtGreaterThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Recent, Recent, QAfterFilterCondition> createdAtLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Recent, Recent, QAfterFilterCondition> createdAtBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Recent, Recent, QAfterFilterCondition> idIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'id',
      ));
  ...
  QueryBuilder<Recent, Recent, QAfterFilterCondition> idIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'id',
      ));
...
extension RecentQueryLinks on QueryBuilder<Recent, Recent, QFilterCondition> {
  QueryBuilder<Recent, Recent, QAfterFilterCondition> subject(
  ...
  QueryBuilder<Recent, Recent, QAfterFilterCondition> subjectIsNull() {
    return QueryBuilder.apply(this, (query) {
...
extension RecentQuerySortBy on QueryBuilder<Recent, Recent, QSortBy> {
  QueryBuilder<Recent, Recent, QAfterSortBy> sortByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.asc);
    });
  }

  QueryBuilder<Recent, Recent, QAfterSortBy> sortByCreatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension RecentQuerySortThenBy on QueryBuilder<Recent, Recent, QSortThenBy> {
  QueryBuilder<Recent, Recent, QAfterSortBy> thenByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.asc);
    });
  }

  QueryBuilder<Recent, Recent, QAfterSortBy> thenByCreatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.desc);
    });
  }
...
extension RecentQueryWhereDistinct on QueryBuilder<Recent, Recent, QDistinct> {
  QueryBuilder<Recent, Recent, QDistinct> distinctByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension RecentQueryProperty on QueryBuilder<Recent, Recent, QQueryProperty> {
  ...
  QueryBuilder<Recent, int?, QQueryOperations> createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
